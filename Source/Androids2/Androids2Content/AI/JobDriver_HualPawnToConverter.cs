...
namespace Androids2
{
    ...
    public class JobDriver_HualPawnToConverter
        : JobDriver
    {
        ...
        public override IEnumerable<Toil> MakeNewToils()
        {
            ...
            yield return Toils_General.Do(delegate
            {
                ...
                Building_Converter building_AndroidConverter = (Building_Converter)this.job.targetB.Thing;
                Job job = JobMaker.MakeJob(A2_Defof.A2_EnterConverter, building_AndroidConverter);

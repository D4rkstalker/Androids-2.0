...
{
    public abstract class CompRepairGantry_RepairCycle : CompRepairGantry_Cycle
    {
        public List<string> tmpWillHealHediffs = new List<string>();

        public List<string> tmpCanHealHediffs = new List<string>();

        public List<Hediff> tmpHediffs = new List<Hediff>();

        public new CompProperties_RepairGantry_RepairCycle Props => (CompProperties_RepairGantry_RepairCycle)props;
        ...
        public override void CycleCompleted(Pawn pawn)
        {
            ...
            try
            {
                foreach (Hediff tmpHediff in tmpHediffs)
                {
                    ...
                    else if (tmpHediff is Hediff_MissingPart { IsFresh: true } hediff_MissingPart)
                    {
        ...
        public bool WillHeal(Pawn pawn, Hediff hediff)
        {
        ...
        public bool CanPotentiallyHeal(Pawn pawn, Hediff hediff)
        {
            if (!hediff.def.everCurableByItem)
            {
                return false;
        ...
        public CompRepairGantry_RepairCycle()
        {
        }
    }
}